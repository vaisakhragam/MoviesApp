...
import com.example.Sourceapp.ui.main.adapter.FavoritesAdapter
import com.example.moviesapplication.R
import com.example.moviesapplication.data.local.db.entities.Movies
import com.example.moviesapplication.ui.main.viewmodel.FavoritesViewModel
...
class FavoritesFragment : Fragment() {
    ...
    private val moviesViewViewModel: FavoritesViewModel by viewModels()
    ...
    override fun onStart() {
        ...
        moviesViewViewModel.getFavorites()
        super.onStart()
    }
    ...
    private fun setupObserver() {
        moviesViewViewModel.movies.observe(viewLifecycleOwner, Observer {
            when (it.status) {
                Status.SUCCESS -> {
    ...
    private fun renderList(allNews: List<Movies>) {
        favoritesAdapter.addData(allNews)
